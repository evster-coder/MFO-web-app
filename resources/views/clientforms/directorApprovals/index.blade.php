...
@section('content')
	<div class="d-flex justify-content-between">
		...
		<div class="dropdown" style="margin-top:auto; margin-bottom: auto;">
		  ...
		  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
		    <li><a class="dropdown-item" id="exportExcelDirector" data-export="{{route('directorApproval.export')}}"><i class="fas fa-file-excel"></i> Excel</a></li>
		  </ul>
		</div>
	</div>
	<div class="content-block">
		...
		<table class="table mb-5" id="directorTable" 
