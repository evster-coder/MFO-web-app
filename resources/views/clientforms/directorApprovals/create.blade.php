...
@section('content')
	<a href="{{route('directorApproval.tasks')}}" class="btn btn-default">< К списку</a>
	...
	<div class="content-block">
    	...
    	<div class="block-padding d-flex">
            ...
            <form method="POST" action="{{route('directorApproval.accept')}}"
                id="accept"
            >
                @csrf
            ...
            <form method="POST" action="{{route('directorApproval.reject')}}"
                id="reject"
            >
                @csrf
                <input type="hidden" name="clientform_id" value="{{$clientform->id}}">
