...
@push('assets')
    ...
    <script src="{{ asset('js/datadictsCRUD/maritalstatus.js') }}" defer></script>
...
@section('content')
    ...
    <div class="content-block">
        ...
        <table class="table table-bordered data-table"
               id="data-table"
               data-url="/maritalstatuses/get-statuses">
            <thead>
            ...
            <tbody>
            <x-maritalstatuses-tbody :statuses="$statuses"/>
            </tbody>
        </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form name="dataForm"
                              id="dataForm"
                              action="{{ route('maritalstatus.store') }}"
                              method="POST">
