...
@push('assets')
    ...
    <script src="{{ asset('js/datadictsCRUD/seniority.js') }}" defer></script>
    <link rel="stylesheet" href="{{ asset('css/datadicts.css') }}">
@endpush

@section('content')
	<h1>Справочник: Стаж работы</h1>
	...
	<x-auth-session-status class="mb-4" :status="session('status')" />
  	<x-auth-validation-errors class="mb-4" :errors="$errors" />
      	...
      	<table class="table table-bordered data-table" id="data-table" data-url="/senioritis/get-senioritis">
            <thead>
            ...
            <tbody>
              <x-senioritis-tbody :senioritis="$senioritis"></x-senioritis-tbody>
            </tbody>
      	</table>
          ...
          <div class="modal-dialog">
            ...
            <h4 class="modal-title" id="dataCrudModal"></h4>
              ...
              <div class="modal-body">
                <form name="dataForm" id="dataForm" action="{{ route('seniority.store') }}" method="POST">
                  ...
                  <div class="row">
                    ...
                    <div class="btn-group block-padding">
                      ...
                      <a href="{{ route('seniority.index') }}" class="btn btn-danger">Отмена</a>
                    </div>
                  </div>
                </form>
              </div>
